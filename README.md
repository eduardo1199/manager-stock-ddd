...
- Quais as ações (casos de uso) que essa aplicação deve ter?
  ...
  - definir limite minimo de estoque para cada produto
  - alertar quando o estoque estiver acabando (E-MAIL)
  - visualizar quantos produtos foram vendidos por período
  - visualizar quais produtos venderam mais
  - visualizar métricas de estoque ao longo do tempo
  - compra automática com base no estoque do produto
  - ver prazos de entrega dos produtos